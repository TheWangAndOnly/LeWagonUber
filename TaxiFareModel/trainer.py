...
class Trainer(object):
    ESTIMATOR = "Linear"
    EXPERIMENT_NAME = "[BE] [BXL] [TheWangAndOnly] TaxifareModel"
    ...
    def __init__(self, X, y, **kwargs):
        ...
        Example:
            TT = Trainer(nrows=1000, estimator="Linear") or Trainer(**kwargs)
               ==> kwargs = {"nrows": 1000,
                            "estimator": "Linear"}
        :param X:
        :param y:
    ...
    def add_grid_search(self):
        ...
        params = {"rgs__" + k: v for k, v in self.model_params.items()} # what a beautiful line of code
...
if __name__ == "__main__":
    ...
    # Get and clean data
    experiment = "taxifare_set_TheWangAndOnly"
